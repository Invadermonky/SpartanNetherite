...
public class ItemGreatswordSN extends ItemGreatsword implements IFireproofItem {
    public ItemGreatswordSN() {
        super(LibNames.greatsword_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
