...
public class ItemSpearSN extends ItemSpear implements IFireproofItem {
    public ItemSpearSN() {
        super(LibNames.spear_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
