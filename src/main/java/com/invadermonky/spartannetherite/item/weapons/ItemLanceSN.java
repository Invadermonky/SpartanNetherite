...
public class ItemLanceSN extends ItemLance implements IFireproofItem {
    public ItemLanceSN() {
        super(LibNames.lance_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
