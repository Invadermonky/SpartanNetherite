...
public class ItemWarhammerSN extends ItemWarhammer implements IFireproofItem {
    public ItemWarhammerSN() {
        super(LibNames.warhammer_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
