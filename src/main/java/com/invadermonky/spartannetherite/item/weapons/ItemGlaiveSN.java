...
public class ItemGlaiveSN extends ItemGlaive implements IFireproofItem {
    public ItemGlaiveSN() {
        super(LibNames.glaive_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
