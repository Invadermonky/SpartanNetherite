...
public class ItemBattleaxeSN extends ItemBattleaxe implements IFireproofItem {
    public ItemBattleaxeSN() {
        super(LibNames.battleaxe_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
