...
public class ItemBoomerangSN extends ItemBoomerang implements IFireproofItem {
    public ItemBoomerangSN() {
        super(LibNames.boomerang_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
