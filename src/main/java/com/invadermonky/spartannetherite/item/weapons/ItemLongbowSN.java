...
public class ItemLongbowSN extends ItemLongbow implements IFireproofItem {
    public ItemLongbowSN() {
        super(LibNames.longbow_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
