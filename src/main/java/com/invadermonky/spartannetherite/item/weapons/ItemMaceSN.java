...
public class ItemMaceSN extends ItemMace implements IFireproofItem {
    public ItemMaceSN() {
        super(LibNames.mace_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
