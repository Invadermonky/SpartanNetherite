...
public class ItemParryingDaggerSN extends ItemParryingDagger implements IFireproofItem {
    public ItemParryingDaggerSN() {
        super(LibNames.parry_netherite, SpartanNetherite.MOD_ID, ToolMaterialsSN.materialex_netherite);
